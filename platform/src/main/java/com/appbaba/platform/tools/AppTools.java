package com.appbaba.platform.tools;
...
import com.appbaba.platform.impl.ImageLoadComplete;
...
public class AppTools {
     ...
     * @see DensityTools#getStatusHeight(Context)
     */
    ...
    /**
     * @return screen width
     * @see ScreenTools#getScreenWidth(Context)
     */
     ...
     * @see ScreenTools#getScreenHeight(Context)
     */
...
//    }
     ...
     * @see com.appbaba.iz.tools.CheckNetworkTools#isNetworkAvailable(Context)
     */
     ...
     * @see CheckNetworkTools#isWifiState(Context)
     */
    ...
    /**
     * @see CheckNetworkTools#openWifi(Context)
     */
