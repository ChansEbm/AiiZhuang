...
public class OkHttpBuilder {
     ...
     */
    private static MediaType getContentType(com.appbaba.platform.eum.MediaType mediaType) {
        switch (mediaType) {
            case JPG:
    ...
    public static class POST {
        ...
        //mediaType
        private MediaType mediaType = getContentType(com.appbaba.platform.eum.MediaType.OCT);
...
//            requestBody = builder.build();
         ...
         * @return this
         */
        public POST mediaType(com.appbaba.platform.eum.MediaType contentMediaType) {
