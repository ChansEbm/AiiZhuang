...
public class CameraPreview extends ViewGroup {
    ...
    protected Rect calculateFramingRect(Rect container, Rect surface) {
        ...
        if(framingRectSize != null) {
            ...
            int verticalMargin = Math.max(0, (intersection.width() - framingRectSize.width) / 2);
            int horizontalMargin = Math.max(0, (intersection.height() - framingRectSize.height) / 4);
            intersection = new Rect(verticalMargin, horizontalMargin,verticalMargin+framingRectSize.width,horizontalMargin+framingRectSize.height);
            return intersection;
        }
