...
public class OkHttpBuilder {
     ...
     */
    private static MediaType getContentType(com.appbaba.iz.eum.MediaType mediaType) {
        switch (mediaType) {
            case JPG:
    ...
    public static class POST {
        ...
        //mediaType
        private MediaType mediaType = getContentType(com.appbaba.iz.eum.MediaType.OCT);
...
//            requestBody = builder.build();
         ...
         * @return this
         */
        public POST mediaType(com.appbaba.iz.eum.MediaType contentMediaType) {
